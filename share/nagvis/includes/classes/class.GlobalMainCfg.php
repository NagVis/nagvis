...
class GlobalMainCfg {
	...
	function GlobalMainCfg($configFile) {
		...
		$this->validConfig = Array(
			...
			'wui' => Array('autoupdatefreq' => Array(
												'must' => 0,
												'editable' => 1,
												'default' => '25',
												'match' => MATCH_INTEGER),
			...
			'paths' => Array('base' => Array(
							...
							'htmlimages' => Array(
												...
												'match' => MATCH_STRING_PATH),
							'htmlhovertemplates' => Array(
												'must' => 0,
												'editable' => 0,
												'default' => '',
												'match' => MATCH_STRING_PATH),
							'htmlheadertemplates' => Array(
												'must' => 0,
												'editable' => 0,
												'default' => '',
												'match' => MATCH_STRING_PATH),			
							'htmlhovertemplateimages' => Array(
												'must' => 0,
												'editable' => 0,
												'default' => '/nagios/nagvis/nagvis/images/templates/hover/',
												'match' => MATCH_STRING_PATH),
							'htmlheadertemplateimages' => Array(
												'must' => 0,
												'editable' => 0,
							...
							'options' => Array(
												...
												'html' => Array('backendid' => Array(
																...
																'cgi' => Array(
																					...
																					'match' => MATCH_STRING_PATH)))),
			'rotation' => Array('rotationid' => Array(
												'must' => 1,
												'editable' => 0,
												'default' => 'demo',
												'match' =>MATCH_STRING_NO_SPACE),
