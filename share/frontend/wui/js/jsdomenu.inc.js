...
function createjsDOMenu() {
	...
	with (mainMenu) {
		...
		addMenuItem(new menuItem("-"));
		addMenuItem(new menuItem(get_label('nagVisConfig'), "", "code:popupWindow('"+get_label('nagVisConfig')+"', getSyncRequest('"+oGeneralProperties.path_server+"?mod=MainCfg&act=edit', true, false), undefined, 970);"));
